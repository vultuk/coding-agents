...
- Project-local Codex skills live under `.agents/skills/` and are discovered from this repository.
- User-scoped Codex installs live under `$CODEX_HOME/skills` (often `~/.codex/skills`).
- Claude Code user-scoped installs live under `~/.claude/skills/`.
