...
| Model ID | Use for |
| --- | --- |
| `gpt-5.5` | Latest/default text and reasoning model for most new apps, including coding and tool-heavy workflows; set `reasoning.effort: none` when an explicit no-reasoning text path is needed |
